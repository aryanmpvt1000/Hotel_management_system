...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/Delux Room Single Bed Ac Room/delux_img1.jpeg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/Delux Room Single Bed Ac Room/delux_img2.jpeg"class="thumbnail" alt="img2">
    </div>

    <div class="item">
       <img src="image/Delux Room Single Bed Ac Room/delux_img3.jpeg"class="thumbnail" alt="img3">
    </div>

    <div class="item">
       <img src="image/Delux Room Single Bed Ac Room/delux_img4.jpeg"class="thumbnail" alt="img4">
    </div>
