...
<body style="margin-top:50px;">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="image/Luxury Room/Luxury_img1.jpeg"class="thumbnail" alt="img1">
    </div>

    <div class="item">
      <img src="image/Luxury Room/Luxury_img2.jpeg"class="thumbnail" alt="im2">
    </div>

    <div class="item">
       <img src="image/Luxury Room/Luxury_img3.jpeg"class="thumbnail" alt="im3">
    </div>

    <div class="item">
       <img src="image/Luxury Room/Luxury_img4.jpeg"class="thumbnail" alt="img4">
    </div>
