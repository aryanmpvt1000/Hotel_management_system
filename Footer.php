...
?>
	...
	<div class="col-sm-4 text-justify">
      ...
      <p style="color:white;"><strong>Contact Us:&nbsp;</strong>(+91) 7982753250</p><br><br><br>
     <center><img src="image/devlop/img2.jpeg"class="img-responsive"style="width:200px;height:150px;border-radius:100%;"></center>
	</div>&nbsp;
...
<footer class="container-fluid text-center"style="background-color:#000408;height:40px;padding-top:10px;color:#f0f0f0;">
  <p>Developed By Aryan&Ekansh | All Rights Reserved 2022</p>
</footer>
